...
public class EventsController {
    ...
    @GetMapping
    // public Iterable<Events> fetchStudent(){
    public ResponseEntity<ResponseData<Events>> fetchStudent() {
    ...
    @GetMapping("/{id}")
    // public Events fetchStudentById(@PathVariable("id") int id){
    public ResponseEntity<ResponseData<Events>> fetchStudentById(@PathVariable("id") int id) {
    ...
    @PutMapping
    // public Events updateStudent(@RequestBody Events events){
    public ResponseEntity<ResponseData<Events>> updateStudent(@Valid @RequestBody Events events, Errors errors) {
        ResponseData<Events> responseData = new ResponseData<>();
    ...
    public ResponseEntity<ResponseData<Events>> deleteStudentById(@PathVariable("id") int id){    
        ResponseData<Events> responseData = new ResponseData<>();
        if(id != 0){
            try {
